...
@NamedQueries(value = {
        ...
        @NamedQuery(name = "Ic.icEligibleYes", query = "SELECT COUNT(ic) FROM IcEntity ic WHERE ic.eligYn = true and ic.eventByIdEvent.subjectByIdSubject.idSubject = :idSubject"),
        ...
        @NamedQuery(name = "Ic.selectIcByIdEvent", query = "SELECT ic FROM IcEntity ic WHERE ic.eventByIdEvent.idEvent = :idEvent")
